exports.sendResetPassword = (url, token) => `
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit;">
                                                                  <span style="font-size: 20px">Kami menerima permintaan untuk mengatur ulang kata sandi Anda. Masukkan kode berikut: </span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px">Atau, Anda bisa mengubah kata sandi secara langsung.</span>
                                                                </div>
                                                                <br/>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <a href="${url}/${token}"
                                                                        ...
                                                                        target="_blank">Ubah Kata Sandi</a>
                                                                </div>
                                                                <br/>
                                                                <hr/>
                                                                <br/>
